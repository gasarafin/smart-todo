...
public class UserTask {
     ...
     */
    public UserTask(int taskID, String taskName, LocalDateTime dueDate, boolean isOutdoors, String gPlaceID, String taskDetails) {
        this.taskID = taskID;
     ...
     * @param isOutdoors is the take an outdoor task? (user required)
     */
    public UserTask(String taskName, boolean isOutdoors) {
        this.taskID = -1;
        this.taskName = taskName;
